...
#' Lockfiles
#'
#' A **lockfile** records the state of a virtual environment at some point in
...
#'
#' While lockfile files are normally generated and used with [snapshot()] /
...
#'
#' An example lockfile file follows:
#'
#' ```
#' [Environment]
