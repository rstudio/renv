...
#'
#' 1. A particular version of \R,
#' 2. A set of library paths,
#'
#' These environments can be shared by multiple projects, and multiple projects
#' can bind to the same `renv`.
#'
"_PACKAGE"
