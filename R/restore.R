...
#' Restore project library from the lockfile
#'
#' Restore a project's dependencies from a lockfile, as previously generated by
#' [snapshot()]. `renv::restore()` compares packages from the lockfile to the
#' project library, installing any changed packages into the project library.
#' If `clean = TRUE`, `restore()` will additionally delete any packages in
#' the project library that don't appear in the lockfile.
#'
#' @inherit renv-params
#'
