...
#' time. Virtual environments can be restored from a manifest using the
...
#'
#' An example manifest file folllows:
#'
#' ```
#' [Environment]
...
#' \strong{Repositories} \tab The \R repositories used in this project.
#' }
#'
#' @section R.Package:
#'
