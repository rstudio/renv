...
[`renv::init()`](https://rstudio.github.io/renv/reference/init.md). It
...
[`vignette("package-install")`](https://rstudio.github.io/renv/articles/package-install.md).
...
and
[`renv::revert()`](https://rstudio.github.io/renv/reference/history.md).
...
[`vignette("package-sources")`](https://rstudio.github.io/renv/articles/package-sources.md).
...
- **Operating system, versions of system libraries, compiler versions**:
  ...
  [`vignette("docker", package = "renv")`](https://rstudio.github.io/renv/articles/docker.md)
