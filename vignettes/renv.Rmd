...
A typical \R installation might have three kinds of library paths available
to the user:
...
```{r}
pkgs <- installed.packages(priority = c("base", "recommended"))
as.data.frame(pkgs[, c("Package", "Version", "Priority", "LibPath")], row.names = NA)
```
