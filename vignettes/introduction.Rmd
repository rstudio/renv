...
In effect, this means that even if multiple projects need to re-use the same
R package dependencies in their own project library, the same underlying
installation of that package can be re-used in each project. And, because
