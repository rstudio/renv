...
This can be useful if you'd like to, for example, enforce the usage of a
[MRAN](https://mran.microsoft.com) checkpoint during restore, or another
similarly-equipped repository.
