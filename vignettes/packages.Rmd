...
see the [CI][ci] vignette for more information. In particular, clever use of
the `renv` cache can help save time that might normally be spent on package
installation.
...
lives outside of your project. For example, you might set the following in your
project `.Renviron`:

```
RENV_PATHS_LIBRARY = /home/$USER/.renv/library/<package>
```

where `<package>` is the name of your package project.





[ci]: https://cran.r-project.org/web/packages/renv/vignettes/ci.html
