...
place the tarball for this package at one of these locations:
...
The main requirement is that your source path exists, and the path has an
extension of either `.tar.gz`, (for source packages), `.tgz` (for macOS
binaries) or `.zip` (for Windows binaries).
