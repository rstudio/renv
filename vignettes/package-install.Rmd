...
renv does build vignettes when installing a package from source.
This is because vignettes option require suggested packages, and installing all suggested packages (particularly from source) is often a large burden.
