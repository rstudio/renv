...
| `RENV_PATHS_LOCKFILE`        | The path to the [lockfile](https://rstudio.github.io/renv/reference/lockfile-api.md).                   |
...
[`restore()`](https://rstudio.github.io/renv/reference/restore.md), renv
will search the cellar for a compatible package, and prefer installation
with that copy of the package if appropriate.
