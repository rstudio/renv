...
[restore](https://rstudio.github.io/renv/reference/restore.md) to
function correctly.
...
[`install()`](https://rstudio.github.io/renv/reference/install.md), what
`DESCRIPTION` fields should be used to determine that package's
...
[snapshot](https://rstudio.github.io/renv/reference/snapshot.md) for
more details.
...
[`vignette("package-sources", package = "renv")`](https://rstudio.github.io/renv/articles/package-sources.md)
