...
- actions:
  ...
  `"snapshot"`, the lockfile is generated from repository metadata (the
  `PACKAGES` file) without installing packages, so it may contain only a
  subset of the fields present in a lockfile generated by
