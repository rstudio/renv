...
[`init()`](https://rstudio.github.io/renv/reference/init.md), and it is
rare that you should need it otherwise, as it can easily get your
...
[`update()`](https://rstudio.github.io/renv/reference/update.md) which
will get the latest versions from CRAN). In this case, you should verify
that your code continues to work, then call
[`snapshot()`](https://rstudio.github.io/renv/reference/snapshot.md) to
record updated package versions in the lockfile.
