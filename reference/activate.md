...
[`init()`](https://rstudio.github.io/renv/reference/init.md), which is
the best way to start using renv in a new project.

`activate()` first calls
[`scaffold()`](https://rstudio.github.io/renv/reference/scaffold.md) to
set up the project infrastructure. Most importantly, this creates a
