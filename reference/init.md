...
2.  Discover the packages that are currently being used in your project
    ...
    [`hydrate()`](https://rstudio.github.io/renv/reference/hydrate.md)),
...
- settings:
  ...
  A list of
  [settings](https://rstudio.github.io/renv/reference/settings.md) to be
  used with the newly-initialized project.
...
- bioconductor:
  ...
  [config](https://rstudio.github.io/renv/reference/config.md) for more
  details.
