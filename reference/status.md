...
[`restore()`](https://rstudio.github.io/renv/reference/restore.md)ing
the project in the future or on another machine.

[`renv::load()`](https://rstudio.github.io/renv/reference/load.md) will
report if any issues are detected when starting an renv project; we
...
## Lockfile vs [`dependencies()`](https://rstudio.github.io/renv/reference/dependencies.md)
...
[`history()`](https://rstudio.github.io/renv/reference/history.md) and
...
[settings](https://rstudio.github.io/renv/reference/settings.md) for
more details.
