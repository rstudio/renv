...
[`restore()`](https://rstudio.github.io/renv/reference/restore.md), they
can also be edited by hand if so desired. Lockfiles are written as
...
[`snapshot()`](https://rstudio.github.io/renv/reference/snapshot.md) and
[`restore()`](https://rstudio.github.io/renv/reference/restore.md) are
the primariy tools you will need when creating and using lockfiles.
