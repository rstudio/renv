...
[sandbox](https://rstudio.github.io/renv/reference/sandbox.md), if
...
[`init()`](https://rstudio.github.io/renv/reference/init.md)/
...
See [`?config`](https://rstudio.github.io/renv/reference/config.md) for
more details.
