...
to [`renv::init()`](https://rstudio.github.io/renv/reference/init.md).
...
documentation in
[`?renv::init`](https://rstudio.github.io/renv/reference/init.md) for
...
[`renv::snapshot()`](https://rstudio.github.io/renv/reference/snapshot.md)
over
[`snapshot()`](https://rstudio.github.io/renv/reference/snapshot.md). By
default, all exported renv functions are attached and placed on the
...
[`install()`](https://rstudio.github.io/renv/reference/install.md) and
...
[`renv::init()`](https://rstudio.github.io/renv/reference/init.md) will
use the P3M instance if the `repos` R option has not already been set by
some other means (for example, in a startup `.Rprofile`). Defaults to
`TRUE`.
...
[`update()`](https://rstudio.github.io/renv/reference/update.md) and
[`remove()`](https://rstudio.github.io/renv/reference/remove.md) as
...
[settings](https://rstudio.github.io/renv/reference/settings.md) can be
used.
